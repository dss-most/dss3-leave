...
public class FrmVehicleReq extends HtmlForm {
    ...
    public static final String ELM_NAME_VEHICLE_REQ_DATE = "vehiclerequestdate";
    public static final String ELM_NAME_VEHICLE_START_TIME = "vehiclestarttime";
    public static final String ELM_NAME_VEHICLE_END_TIME = "vehicleendtime";
    public static final String ELM_NAME_PLACE_TO_GO = "placetogo";
    public static final String ELM_NAME_REASON_TO_GO = "reasontogo";
