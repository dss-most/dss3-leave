...
<%@include file="/WEB-INF/jspf/dateInput.jspf" %>
 <input type="hidden" name="<%=thisForm.ELM_NAME_TO_COUNTRY%>" style="width:241px;" value="-"/><br />
<span style="vertical-align:top;">*เนื่องจาก  : </span><textarea name="<%=thisForm.ELM_NAME_CONTACT_DETAIL%>" style="width:241px;height:85px;"><%=thisForm.getValue(thisForm.ELM_NAME_CONTACT_DETAIL)%></textarea><br />
 <input type="hidden" name="<%=thisForm.ELM_NAME_REMARK%>" style="width:241px;" value="<%=thisForm.getValue(thisForm.ELM_NAME_REMARK)%>"/><br />
