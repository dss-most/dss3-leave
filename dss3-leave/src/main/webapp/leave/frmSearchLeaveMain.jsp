...
<form name="searchForm" action="index.jsp?#content" method="post">
    ...
    สถานะคำร้อง : <select name="<%=thisForm.ELM_NAME_SEARCH_FORM_STATUS%>">
...
<script language="JavaScript">
    ...
    document.all['<%=thisForm.ELM_NAME_SEARCH_FORM_STATUS%>'].style.width = "211px";
    document.all['<%=thisForm.ELM_NAME_SEARCH_FORM_STATUS%>'].style.margin = "0 0 1px 0";
    ...
    function clearSearchForm(){
        ...
        document.searchForm.<%=thisForm.ELM_NAME_SEARCH_FORM_TYPE%>.selectedIndex = 0;
        document.searchForm.<%=thisForm.ELM_NAME_SEARCH_FORM_STATUS%>.selectedIndex = 0;
    }
